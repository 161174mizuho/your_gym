...
店舗：設置されているマシン（鍛えられる部位）をＵＰすることができ、投稿のいいね数などをもとに、顧客満足度向上や販促活動・退会抑止に生かすことが可能です。
...
店舗：新規登録から、店舗情報やマシン・鍛える部位などを登録します。投稿一覧から利用者の投稿を閲覧でき、投稿の詳細ページにはいいね、コメントが表示されます。
いいね数などをもとに、今後の店舗運営の材料として使用できます。
...
## 設計書
https://docs.google.com/spreadsheets/d/1s7AgCYwGSpRZmNiIoeY78FVuuYZs_6W8/edit?usp=sharing&ouid=102261574874352104993&rtpof=true&sd=true

## テスト仕様書
https://docs.google.com/spreadsheets/d/1d0PQt82UyjaWtWlolPWHxG1hvzcUFYu4/edit?usp=sharing&ouid=102261574874352104993&rtpof=true&sd=true
